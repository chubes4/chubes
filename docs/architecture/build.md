...
- Exclusions: the script excludes .git*, .DS_Store, build/, dist/, build.sh, CLAUDE.md, README.md, AGENTS.md, .claude/, and other developer files (see build.sh for exact excludes).
